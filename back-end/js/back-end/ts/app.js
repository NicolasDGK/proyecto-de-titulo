...
const PriceHistory = require('./Precio_Historico/get_price_history');
app.get('/PriceHistory/:id', PriceHistory.GetPriceHistory);
/*app.get('/PriceHistory/:id', (req:any, res:any) => {
  const id = +req.params.id;
  PriceHistory.GetPriceHistory(req, res, id);
});*/
